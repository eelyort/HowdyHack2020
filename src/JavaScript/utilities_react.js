...
export {Fragment, WindowSizes, Button, ToggleButton, HoldButton, Select, /*TextArea,*/ NumberForm, SquareFill, FadeDiv, TypewriterText, ImgIcon, Menu, FadeMenu, MenuInsides, MouseEnterExitDiv, MouseFadeDiv, CollapsibleDiv, PopUp, VerticalCarousel};